...
if __name__ == '__main__':
    ...
    #WZN: this allows test and train run together, test waits for train to complete
    ...
    #WZN: note according to factory.py this will only load kitti_mv3d
    ...
    #WZN: reads the network definition
