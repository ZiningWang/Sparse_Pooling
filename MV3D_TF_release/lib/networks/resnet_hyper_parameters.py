...
tf.app.flags.DEFINE_string('version', 'test_56', '''A version number defining the directory to save
logs and checkpoints''')
tf.app.flags.DEFINE_integer('report_freq', 3000, '''Steps takes to output errors on the screen
and write summaries''')
