...
def drawBox3D(img, corners):
    ...
    color_in_use = (255, 255, 255)
    thickness = 1
    cv2.line(img, (corners[0,0], corners[1,0]), (corners[0,1], corners[1,1]), thickness=thickness, color=color_in_use)
    cv2.line(img, (corners[0,1], corners[1,1]), (corners[0,2], corners[1,2]), thickness=thickness, color=color_in_use)
    cv2.line(img, (corners[0,2], corners[1,2]), (corners[0,3], corners[1,3]), thickness=thickness, color=color_in_use)
    cv2.line(img, (corners[0,3], corners[1,3]), (corners[0,0], corners[1,0]), thickness=thickness, color=color_in_use)

    cv2.line(img, (corners[0,4], corners[1,4]), (corners[0,5], corners[1,5]), thickness=thickness, color=color_in_use)
    cv2.line(img, (corners[0,5], corners[1,5]), (corners[0,6], corners[1,6]), thickness=thickness, color=color_in_use)
    cv2.line(img, (corners[0,6], corners[1,6]), (corners[0,7], corners[1,7]), thickness=thickness, color=color_in_use)
    cv2.line(img, (corners[0,7], corners[1,7]), (corners[0,4], corners[1,4]), thickness=thickness, color=color_in_use)

    cv2.line(img, (corners[0,0], corners[1,0]), (corners[0,4], corners[1,4]), thickness=thickness, color=color_in_use)
    cv2.line(img, (corners[0,1], corners[1,1]), (corners[0,5], corners[1,5]), thickness=thickness, color=color_in_use)
    cv2.line(img, (corners[0,2], corners[1,2]), (corners[0,6], corners[1,6]), thickness=thickness, color=color_in_use)
    cv2.line(img, (corners[0,3], corners[1,3]), (corners[0,7], corners[1,7]), thickness=thickness, color=color_in_use)
