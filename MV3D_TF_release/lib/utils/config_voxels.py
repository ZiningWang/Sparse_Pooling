...
# selected object
__C.DETECT_OBJ = 'Pedestrian'  # Pedestrian/Cyclist/Car
if __C.DETECT_OBJ == 'Car':
    __C.Y_MIN = -40
    __C.Y_MAX = 40
    __C.X_MIN = 0
    __C.X_MAX = 70.4
    __C.Z_MIN = -1  #WZN: this is changed to camera frame!!!! paper is in lidar frame!!
    __C.Z_MAX = 3    #WZN: this is changed to camera frame!!!!
    ...
    __C.X_MIN = 0
    __C.X_MAX = 48
    __C.Z_MIN = -1   #WZN: this is changed to camera frame!!!!
    __C.Z_MAX = 3     #WZN: this is changed to camera frame!!!!
    __C.VOXEL_X_SIZE = 0.2
    __C.VOXEL_Y_SIZE = 0.2
    __C.VOXEL_Z_SIZE = 0.4
...
#WZN: for anchor labeling
__C.ANGLE_WEIGHT = 1.0
__C.ANCHOR_ANGLE_THRESOLD=__C.ANGLE_WEIGHT*np.pi/3
