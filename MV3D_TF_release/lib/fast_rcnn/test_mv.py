...
def test_net(sess, net, imdb, weights_filename , max_per_image=300, thresh=0.05, vis=False):
    ...
    for i in xrange(num_images):
        ...
        #WZN: threshold for deleting low score detections
        thresh = 0.05
        ...
        for j in xrange(1, imdb.num_classes):
            ...
            #WZN: put detected boxes and scores together
            ...
            if np.any(cls_dets_cnr):
                ...
                if 1:
                    ...
                    print corners_r
            #WZN: This will return error in VNC server but no error on Workstation, commented
