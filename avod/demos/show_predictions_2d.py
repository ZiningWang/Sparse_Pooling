...
def main():
    ...
    # Options
    ##############################
    dataset_config.data_split = 'test' #'val'
    ...
    checkpoint_name = 'pyramid_people_example' #'pyramid_people_example_train'
    ...
    for sample_idx in range(dataset.num_samples):
        ...
        #print('dataset.has_labels',dataset.has_labels)
...
def draw_proposals(filtered_gt_objs,
    ...
    for obj in filtered_gt_objs:
        ...
        vis_utils.draw_box_2d(
            prop_2d_axes, obj, test_mode=True, color_tm='r', linewidth=linewidth)
